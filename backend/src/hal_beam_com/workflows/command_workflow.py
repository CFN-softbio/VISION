...
from src.hal_beam_com.utils import SystemPromptType, get_model_config
...
def run(data, queue, audio_base_model=None, audio_finetuned=False, text_base_model=None, text_finetuned=False, use_static_prompt=False):
    ...
    data = classifier_cog.invoke(data, base_model=text_base_model, finetuned=text_finetuned,
